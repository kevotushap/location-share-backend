...
def get_latest_location():
    ...
    if 'text/html' in accept:
        if latest_location and 'latitude' in latest_location and 'longitude' in latest_location:
            html = """
            <!DOCTYPE html>
            <html>
            <head>
            ...
            # Location exists but missing lat/lon
            html = """
            <html>
            <head><title>No Coordinates</title></head>
            <body><h2>Latest location does not include coordinates.</h2></body>
            </html>
            """
            return html, 200
        else:
